...
class TextSplit extends React.Component {
  ...
  renderPart(text, index) {
    ...
    var classString = `${partNumber} ${this.props.classBase}-part ${this.props.classBase}-content-${text}`;
    ...
    return <span aria-hidden className={classString} key={index} style={{ zIndex: this.props.text.length - index }}>{text}</span>;
  }
